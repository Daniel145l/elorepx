import { CHANNEL_EVENTS, CHANNEL_STATES, DEFAULT_POSTGRES_CHANGES_WAIT_TIMEOUT, POSTGRES_CHANGES_WAIT_ERROR_GRACE, } from './lib/constants';
...
export default class RealtimeChannel {
    ...
    subscribe(callback, timeout = this.timeout) {
        ...
        if (this.channelAdapter.isClosed()) {
            ...
            const joinTimeout = (postgres_changes_options === null || postgres_changes_options === void 0 ? void 0 : postgres_changes_options.wait) && postgres_changes.length > 0
                ? Math.max(timeout, ((_d = postgres_changes_options.timeout) !== null && _d !== void 0 ? _d : DEFAULT_POSTGRES_CHANGES_WAIT_TIMEOUT) +
