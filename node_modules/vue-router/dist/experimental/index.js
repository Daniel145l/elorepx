...
* @license MIT
*/
import { A as PLUS_RE, C as isSameRouteLocation, D as resolveRelativePath, F as isBrowser, N as encodeParam, P as encodePath, S as START_LOCATION_NORMALIZED, _ as saveScrollPosition, c as useCallbacks, d as stringifyQuery, g as getScrollKey, h as getSavedScrollPosition, i as guardToPromiseFn, j as decode, n as extractChangingRecords, r as extractComponentsGuards, t as addDevtools, v as scrollToPosition, x as NEW_stringifyURL } from "../devtools-CN5uWJaH.js";
import { a as routerKey, b as noop, c as diagnostics, d as isNavigationFailure, g as isArray, i as routeLocationKey, m as identityFn, n as useRouter, o as routerViewLocationKey, p as assign, t as useRoute, u as createRouterError } from "../useApi-BPuI6ZR9.js";
import { _ as LOADER_SET_KEY, b as toLazyValue, c as setCurrentContext, d as ABORT_CONTROLLER_KEY, f as APP_KEY, g as LOADER_ENTRIES_KEY, h as IS_USE_DATA_LOADER_KEY, i as useIsDataLoading, l as trackRoute, m as IS_SSR_KEY, n as NavigationResult$1, o as getCurrentContext, r as reroute, t as DataLoaderPlugin, u as withLoaderContext, v as PENDING_LOCATION_KEY, y as STAGED_NO_VALUE } from "../navigation-guard-Csroba8S.js";
...
function experimental_createRouter(options) {
	...
	function resolve(...[to, currentLocation]) {
		const matchedRoute = resolver.resolve(to, currentLocation ?? (typeof to === "string" && !to.startsWith("/") ? currentRoute.value : void 0));
...
var MatcherPatternQueryParam = class {
	...
	match(query) {
		...
		if (Array.isArray(valueBeforeParse)) {
			if (queryValue === void 0 && this.defaultValue !== void 0) value = toValue(this.defaultValue);
			else try {
	...
	function load(to, router, from, parent) {
		...
		const currentLoad = Promise.resolve(loader(to, { signal: to.meta[ABORT_CONTROLLER_KEY]?.signal })).then((d) => {
			if (entry.pendingLoad === currentLoad) {
				if (d instanceof NavigationResult$1) {
					if (process.env.NODE_ENV !== "production") {
