...
type PathSubSegment = string | TreePathParam;
declare class _TreeNodeValueBase {
  ...
  constructor(rawSegment: string, parent: TreeNodeValue | undefined, pathSegment?: string, subSegments?: PathSubSegment[]);
  /**
